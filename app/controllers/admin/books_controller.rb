class Admin::BooksController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @book.save
      format.html { redirect_to @book, notice: t(:product_was_successfully_created)
      }
...
# PATCH/PUT /books/1
  ...
  def update
    respond_to do |format|
      if @book.update(book_params)
        format.html { redirect_to @book, notice: t(:product_was_successfully_updated) }
  ...
  def destroy
    @book.destroy
    respond_to do |format|
      format.html { redirect_to books_url, notice: t(:product_was_successfully_destroyed) }
